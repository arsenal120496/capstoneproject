...
import com.example.administrator.app_control.Fragment.AboutUsFragment;
import com.example.administrator.app_control.Fragment.HomeFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TAG_ROBOT = "robot";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            Toast.makeText(getApplicationContext(),"abcd", Toast.LENGTH_LONG);
            navItemIndex = 0;
